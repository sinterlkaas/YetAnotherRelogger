...
namespace YetAnotherRelogger
{
    public sealed class StatsUpdater
    {
                        ...
                        try
                        {
                            if (bot.IsRunning)
                            {
                                ...
                                if (serie == null)
                                {
                                    ...
                                    foreach (
                                        var color in ChartColors.Where(color => graph.Series.All(x => x.Color != color))
                                        )
        ...
        {
            if (Program.Mainform == null || Program.Mainform.GoldStats == null) return;
            try
            {
                Program.Mainform.Invoke(new Action(() =>
                    {
        ...
        {
            if (Program.Mainform == null || Program.Mainform.CommConnections == null) return;
            try
            {
                Program.Mainform.Invoke(new Action(() =>
                    {
        ...
        {
            if (Program.Mainform == null || Program.Mainform.CpuUsage == null) return;
            try
            {
                Program.Mainform.Invoke(new Action(() =>
                    {
        ...
        {
            if (Program.Mainform == null || Program.Mainform.MemoryUsage == null) return;
            try
            {
                Program.Mainform.Invoke(new Action(() =>
                    {
        ...
        {
            if (Program.Mainform == null || graph == null) return;
            try
            {
                Program.Mainform.Invoke(new Action(() =>
                    {
        ...
        {
            if (Program.Mainform == null || label == null) return;
            try
            {
                Program.Mainform.Invoke(new Action(() =>
                    {
